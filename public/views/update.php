        ...
        <form action="../../src/record_handler.php" method="POST" class="process-wrapper">
            ...
            <div class="process">
                <div class="input-wrapper">
                    <label for="email">
                        <input type="email" name="email" id="email" list="emails" oninput="dataCorrection()" <?php echo "value='".$data['email']."'"; ?> required>
                        <datalist name="emails" id="emails"> </datalist>
                    </label>
                </div>
                <div class="input-wrapper">
                    <label for="instructorName">
                        <input type="text" name="instructorName" id="instructorName" list="instructors" oninput="emailSuggestion()" <?php echo "value='".$data['instructorName']."'"; ?> required>
